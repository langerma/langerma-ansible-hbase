...
export HBASE_MASTER_OPTS="$HBASE_MASTER_OPTS $HBASE_JMX_BASE -Dcom.sun.management.jmxremote.port=10101 -javaagent:{{ hbase_install_dir }}/{{ hbase_version }}/jmx_prometheus_javaagent.jar={{ master_prometheus_jmx_port }}:{{ hbase_conf_dir }}/config.yml"
export HBASE_REGIONSERVER_OPTS="$HBASE_REGIONSERVER_OPTS $HBASE_JMX_BASE -Dcom.sun.management.jmxremote.port={{ hbase_rs_jmxremote_port }} -javaagent:{{ hbase_install_dir }}/{{ hbase_version }}/jmx_prometheus_javaagent.jar={{ regionserver_prometheus_jmx_port }}:{{ hbase_conf_dir }}/config.yml"
